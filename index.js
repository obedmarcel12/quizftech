const questions = [
  ...
  {
    questions: "which is the most talented comedian",
    answers: [
      { text: "Obed marcel", correct: true },
      { text: "Brainjotter", correct: false },
      { text: "Ayo", correct: false },
      { text: "Sabinus", correct: false },
    ],
  },
  {
    questions:"which is the most stingy person in the world",
    answers:[
      {text: "Joy",correct:false},
      {text: "Amanda",correct:false},
      {text: "Ogoo",correct:false},
